...
// const Checkout = () => {
//     const { cart, setCart, contador, setContador, quantity, setQuantity, total, setTotal, vaciarCarrito } = useContext(CartContext);
...
//                     </div>
//                     <div>
//                         <span className="rounded-circle">3</span>
//                     </div>
//                 </div>
//                 <div className="checkout-contenedor rounded-3 border border-dark shadow p-3 mb-5 bg-body-tertiary" >
...
//                                 </div>
//                                 <div>
//                                     <p className="checkout-precio">${item.precio}.00</p>
//                                 </div>
//                             </div>
