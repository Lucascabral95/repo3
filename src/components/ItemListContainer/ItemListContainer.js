...
function Contador() {
  ...
  const { data, setData, loadingSkeleton, setLoadingSkeleton, cantidad, setWish, wishProducto, setWishProducto, setWishlistOn, wishCantidad, setWishCantidad } = useContext(CartContext)
...
// function Contador() {
//   const { data, setData, loadingSkeleton, setLoadingSkeleton, cantidad,
//      setWish, wishProducto, setWishProducto, setWishlistOn,
