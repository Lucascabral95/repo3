...
function Contador() {
  const { data, setData, loadingSkeleton, setLoadingSkeleton, cart, setCart, producto, setproducto, cantidad, setCantidad, contador, setContador, wish, setWish, wishProducto, setWishProducto } = useContext(CartContext)
  ...
  const handleWish = (producto) => {
    ...
    // setWishProducto([...wishProducto , producto]);
    setWish(false)
    toast.success(`¡Usted ha agregado ${producto.categoria} de "${producto.nombre}" a Favoritos!`)
  }
              ...
              {data.map((producto) => (
                <div className="card" style={{ width: "18rem" }} key={producto.id}>
                  ...
                  <div className="card-body">
                    ...
                    <p> <Skeleton /> </p>
                    {/* <Link to={`/productos/detalle/${producto.id}`} className='btn btn-primary'> <Skeleton /> </Link> */}
            ...
            {/* <div className="row">
                {data.map((producto) => (
                  <div className="card" style={{ width: "18rem" }} key={producto.id}>
                    ...
                    />
                    {wish ? <AiOutlineHeart size={30} /> : <AiFillHeart size={30} /> }
                    <div className="card-body">
